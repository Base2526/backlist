...
const NewPostPage = (props) => {
    ...
    */
    ...
    const handleFormSubmit = async(e) => {
      ...
      console.log('idCardNumber : ', idCardNumber)
      console.log('sellingWebsite : ', sellingWebsite)
      console.log('transferDate : ', toTimestamp( transferDate ))
      console.log('detail : ', detail)
      console.log('itemsMBA : ', itemsMBA)
      console.log('files : ', files)
      ...
      // }else{
        ...
        formData.append('id_card_number', idCardNumber);
        formData.append('selling_website', sellingWebsite);
        formData.append('transfer_date', toTimestamp( transferDate ));
        formData.append('detail', detail);
        formData.append('merchant_bank_account', JSON.stringify(itemsMBA));
      ...
      for (var i = 0; i < fileList.length; i++) {
        ...
        if(file !== undefined ){
          if(!_.isEmpty(temp_files)){
            let find = temp_files.find((m)=>{ return m.name.localeCompare(file.name) === 0 })
            if( find === undefined ){
              is_new = true
            }
          }else{
    ...
    const bodyContent = () =>{
      return  <form className="form-horizontal form-loanable"  onSubmit= {handleFormSubmit} >
                <fieldset>
                ...
                <div className="form-action">
                  ...
                  {/* <button
                      ...
                      Create
                      {createLoading && <CircularProgress size={10}/>} </button>*/}
